...
exports.commands = {
	...
	ontime: function (target, room, user) {
		...
		if (isConnected) {
			this.sendReplyBox('<b>' + Exiled.nameColor(userid) + '</b>\'s total ontime is <b>' + displayTime(convertTime(totalOntime)) + '</b>.' + ' Current ontime: <b>' + displayTime(convertTime((currentOntime))) + '</b>.');
		} else {
			this.sendReplyBox('<b>' + Exiled.nameColor(userid) + '</b>\'s total ontime is <b>' + displayTime(convertTime(totalOntime)) + '</b>.' + ' Currently not online.');
		}
	},
