...
exports.commands = {
	...
	lastactive: function (target, room, user) {
		...
		return this.sendReplyBox(`${Server.nameColor(targetUser, true, true)} was last active <strong>${Chat.toDurationString(Date.now() - targetUser.lastPublicMessage)} ago</strong> saying "${targetUser.lastPublicMessage}".`);
	},
