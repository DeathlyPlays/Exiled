...
exports.Formats = [
	...
	},
	{
		...
		mod: 'gen7',
		ruleset: ['[Gen 7] OU'],
		banlist: ['Allow One Sketch', 'Arena Trap + Dark Void', 'Arena Trap + Grass Whistle', 'Arena Trap + Hypnosis', 'Arena Trap + Relic Song', 'Arena Trap + Sing', 'Arena Trap + Sleep Powder',
		],
