...
exports.commands = {
	...
	tsumeta: {
		give: function (target, room, user) {
			...
			if (Users(tsuMetaMember)) Users(tsuMetaMember).popup(`|html|You have been added into the TsuMeta Council by ${Server.nameColor(user.name, true)}.`);
		},
		...
		take: function (target, room, user) {
			...
			if (Users(tsuMetaMember)) Users(tsuMetaMember).popup(`|html|You have been removed from the TsuMeta Council by ${Server.nameColor(user.name, true)}.`);
		},
	...
	tsumetahelp: [
		...
		/tsumeta propose [what you modified], [change requested] - Proposes a change for the TsuMeta metagame. Must be in the TsuMeta Council to use this command.
		/tsumeta edit [proposal], [description update] - Edits a proposal. Must be the submitter of the proposal, Desokoro, or xcmr.
