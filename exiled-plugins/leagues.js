...
function leaguePM(message, league) {
	...
	for (let u in leagues[leagueid].users) {
		...
		Users(leagues[leagueid].users[u]).send("|pm|~" + Config.serverName + " Server|~|/raw " + message);
	}
}
...
exports.commands = {
	...
	league: {
		...
		invite: function (target, room, user) {
			...
			leaguePM(Server.nameColor(user.name, true) + " has invited " + Server.nameColor(targetUser.name, true) + " to join the league.", leagueid);
		...
		accept: function (target, room, user) {
			...
			leaguePM(Server.nameColor(user.name, true) + " has accepted their invitation to join the league.", leagueid);
		...
		decline: function (target, room, user) {
			...
			leaguePM(Server.nameColor(user.name, true) + " has declined their invitation to join the league.", leagueid);
		...
		kick: function (target, room, user) {
			...
			leaguePM(Server.nameColor(user.name, true) + " has kicked " + Server.nameColor(target, true) + " from the league.", leagueid);

			if (Users(target) && Users(target).connected) Users(target).send("|popup||html|" + Server.nameColor(user.name, true) + " has kicked you from the league " + Chat.escapeHTML(leagues[leagueid].name) + ".");
		...
		leave: function (target, room, user) {
			...
			leaguePM(Server.nameColor(user.name, true) + " has left the league.", leagueid);
		...
		desc: function (target, room, user) {
			...
			leaguePM(Server.nameColor(user.name, true) + " has set the league description to '" + Chat.escapeHTML(target) + "'.", leagueid);
		...
		pm: function (target, room, user) {
			...
			leaguePM("League announcement from " + Server.nameColor(user.name, true) + ":<br />" + Chat.escapeHTML(target), leagueid);
		},
		...
		rank: {
			...
			give: function (target, room, user) {
				...
				targetUser.send("|popup||html|" + Server.nameColor(user.name, true) + " has set your league rank in " + Chat.escapeHTML(leagues[leagueid].name) + " to " +
			...
			take: function (target, room, user) {
				...
				if (Users(targetUser) && Users(targetUser).connected) {
					Users(targetUser).send("|popup||html|" + Server.nameColor(user.name, true) + " has removed you from the league rank " + Chat.escapeHTML(rank) + " in " +
		...
		badge: {
			...
			give: function (target, room, user) {
				...
				if (Users(targetUser) && Users(targetUser).connected) {
					Users(targetUser).send("|popup||html|" + Server.nameColor(user.name, true) + " has given you the league badge " + Chat.escapeHTML(badgeName) + " in " + Chat.escapeHTML(leagues[leagueid].name) + ".");
				}
			...
			take: function (target, room, user) {
				...
				if (Users(targetUser) && Users(targetUser).connected) {
					Users(targetUser).send("|popup||html|" + Server.nameColor(user.name, true) + " has taken the league badge " + Chat.escapeHTML(badgeName) + " from you in " + Chat.escapeHTML(leagues[leagueid].name) + ".");
				}
			...
			view: function (target, room, user) {
				...
				if (badges.length < 1) return this.sendReplyBox(Server.nameColor(target, true) + " has no league badges.");
				let output = Server.nameColor(target, true) + "'s league badges:<br /><br />";
				for (let u in badges) {
		...
		lvl: {
			accept: function (target, room, user) {
				...
				leaguePM(Server.nameColor(user.name, true) + ' has accepted the League vs League challenge against ' + Chat.escapeHTML(leagues[targetLeagueid].name), leagueId);
				leaguePM(Server.nameColor(user.name, true) + ' (' + leagues[leagueId].name + ') has accepted the League vs League challenge against your league.', targetLeagueid);
			...
			deny: function (target, room, user) {
				...
				leaguePM(Server.nameColor(user.name, true) + ' has declined the League vs League challenge against ' + Chat.escapeHTML(leagues[targetLeagueid].name), leagueId);
				leaguePM(Server.nameColor(user.name, true) + ' (' + leagues[leagueId].name + ') has declined the League vs League challenge against your league.', targetLeagueid);
				...
				leaguePM(Server.nameColor(user.name, true) + ' has forcibly ended the League vs League with ' + Chat.escapeHTML(leagues[targetLeagueid].name) + '.', leagueId);
			...
			invite: function (target, room, user) {
				...
				leaguePM(Server.nameColor(user.name, true) + " has invited " + Server.nameColor(targetUser.name, true) + " to join the League vs League against " + Chat.escapeHTML(leagues[targetLeague.id].name), leagueId);
				targetUser.send("|popup||modal||html|" + Server.nameColor(user.name, true) + " has invited you to join the League vs League against " + Chat.escapeHTML(leagues[targetLeague.id].name) +
			...
			challenge: function (target, room, user) {
				...
				leaguePM(
					Server.nameColor(user.name, true) + ' (' + Chat.escapeHTML(getLeague(user.userid)) + ') has challenged your league to a League vs League (' +
					size + 'v' + size + ') in' +
				...
				leaguePM(
					Server.nameColor(user.name, true) + ' has challenged ' + Chat.escapeHTML(leagues[targetLeagueid].name) + ' to a League vs League (' +
		...
		points: {
			give: function (target, room, user) {
				...
				leaguePM(Server.nameColor(user.name, true) + " has given your league " + amount + (amount === 1 ? " point." : " points."), league);
			},
			...
			take: function (target, room, user) {
				...
				leaguePM(Server.nameColor(user.name, true) + " has taken " + amount + (amount === 1 ? " point " : " points ") + " from your league.", league);
			},
