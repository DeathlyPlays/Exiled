...
<<<<<<< HEAD
		buffer += '<div class="chat"><font color="gray">[' + timeStr + ' ago]</font> ' + Dew.nameColor(toId(tellsToSend[i].sender), true) + tellsToSend[i].sender + ':</font></b> ' + Chat.escapeHTML(tellsToSend[i].msg.replace(/\|/g, '&#124;')) + '</div>';
=======
		buffer += '<div class="chat"><font color="gray">[' + timeStr + ' ago]</font> ' + Exiled.nameColor(toId(tellsToSend[i].sender), true) + ':</font></b> ' + Chat.escapeHTML(tellsToSend[i].msg.replace(/\|/g, '&#124;')) + '</div>';
>>>>>>> b7a673f7baa8cbb707d8260fe9a5a116ec38049e
	}
	user.send(buffer);
