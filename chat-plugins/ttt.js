...
let TicTacToe = (function () {
	...
	TicTacToe.prototype.accept = function () {
		...
		this.phase = 'started';
		this.resetTimer();
		let message = 'If you accidentally close out, use <em><b>/ttt open</b></em> to reopen the game.';
...
let cmds = {
	...
	help: function (target, room, user) {
		...
		this.sendReplyBox('<div style="background-color: #627ADC ; border: 12px double #3D668E ; color: #FFF"><center><h3><img style="transform: scaleX(-1);" src="http://pldh.net/media/pokemon/gen6/xy-animated/006-mega-x.gif" height="87" width="121" align="left"><font face="arial" size="4"><u><b>Tic-Tac-Toe commands</b></u></font><img src="http://pldh.net/media/pokemon/gen6/xy-animated/006-mega-x.gif" height="87" width="121" align="right"></h3></center><br><br><br><br><br><center><font face="arial" size="2">' +
			'\/ttt c <em>User</em> - Sends a user a request to play Tic-Tac-Toe. This can also be used in PMs.<br><br> (Requests automatically expire if they\'re not accepted or declined within 1.5 minutes.)<br><br>' +
			'/ttt accept <em>User</em>  - Accepts a Tic-Tac-Toe game request from a user.<br><br>' +
			'/ttt decline <em>User</em> - Declines a Tic-Tac-Toe request from a user.<br><br>' +
			'/ttt see or /ttt show - Opens up the Tic-Tac-Toe board, in case you accidentally close it.<br>' +
			'/ttt end - Ends the current game of Tic-Tac-Toe.<br><br>Cancels a play request if the game hasn\'t been started yet.<br><br>(Note: The game automatically ends after a user stays inactive for more than 30 seconds.)<br><br></font></center></div>'
		);
	},
	...
	c: function (target, room, user, connection, cmd) {
		...
		if (target.userid in tttplayers) {
			let game = tttgames[tttplayers[target.userid]];
