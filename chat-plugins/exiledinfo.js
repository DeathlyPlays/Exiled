...
exports.commands = {
	...
	mewth: function (target, room, user) {
		...
		this.sendReplyBox(
			...
			//Mega Ludicolo
			'<div class="infobox"><ul class="utilichart"><li class="result"><span class="col numcol">UU</span> <span class="col iconcol"><span style="background:transparent url(//play.pokemonshowdown.com/sprites/smicons-sheet.png?a1) no-repeat scroll -240px -390px"></span></span> <span class="col pokemonnamecol" style="white-space:nowrap"><a href="https://pokemonshowdown.com/dex/pokemon/ludicolo" target="_blank">Ludicolo-Mega</a></span> <span class="col typecol"><img src="//play.pokemonshowdown.com/sprites/types/Water.png" alt="Water" height="14" width="32"><img src="//play.pokemonshowdown.com/sprites/types/Grass.png" alt="Grass" height="14" width="32"></span> <span style="float:left;min-height:26px"><span class="col abilityco">Drizzle</span></span><span style="float:left;min-height:26px"><span class="col statcol"><em>HP</em><br>90</span> <span class="col statcol"><em>Atk</em><br>60</span> <span class="col statcol"><em>Def</em><br>100</span> <span class="col statcol"><em>SpA</em><br>120</span> <span class="col statcol"><em>SpD</em><br>110</span> <span class="col statcol"><em>Spe</em><br>100</span> <span class="col bstcol"><em>BST<br>580</em></span> </span></li><li style="clear:both"></li></ul></div><br />' +
			//Mega Carbink
			'<div class="infobox"><ul class="utilichart"><li class="result"><span class="col numcol">New</span> <span class="col iconcol"><span style="background:transparent url(//play.pokemonshowdown.com/sprites/smicons-sheet.png?a1) no-repeat scroll -280px -1740px"></span></span> <span class="col pokemonnamecol" style="white-space:nowrap"><a href="https://pokemonshowdown.com/dex/pokemon/carbink" target="_blank">Carbink</a></span> <span class="col typecol"><img src="//play.pokemonshowdown.com/sprites/types/Rock.png" alt="Rock" height="14" width="32"><img src="//play.pokemonshowdown.com/sprites/types/Fairy.png" alt="Fairy" height="14" width="32"></span> <span style="float:left;min-height:26px"><span class="col abilitycol">Clear Body</span><span class="col abilitycol"><em>Sturdy</em></span></span><span style="float:left;min-height:26px"><span class="col statcol"><em>HP</em><br>50</span> <span class="col statcol"><em>Atk</em><br>50</span> <span class="col statcol"><em>Def</em><br>150</span> <span class="col statcol"><em>SpA</em><br>50</span> <span class="col statcol"><em>SpD</em><br>150</span> <span class="col statcol"><em>Spe</em><br>50</span> <span class="col bstcol"><em>BST<br>500</em></span> </span></li><li style="clear:both"></li></ul></div><br />'
		);
	},
