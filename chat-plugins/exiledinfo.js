...
exports.commands = {
	...
	mewth: function (target, room, user) {
		if (!this.runBroadcast()) return;
		this.sendReplyBox(
			"<div class=\"infobox\"><ul class=\"utilichart\"><li class=\"result\"><span class=\"col numcol\">New</span> <span class=\"col iconcol\"><span style=\"background:transparent url(//play.pokemonshowdown.com/sprites/smicons-sheet.png?a1) no-repeat scroll -120px -1440px\"></span></span> <span class=\"col pokemonnamecol\" style=\"white-space:nowrap\"><a href=\"https://pokemonshowdown.com/dex/pokemon/reuniclus-mega\" target=\"_blank\">Reuniclus-Mega</a></span> <span class=\"col typecol\"><img src=\"//play.pokemonshowdown.com/sprites/types/Psychic.png\" alt=\"Psychic\" height=\"14\" width=\"32\"></span> <span style=\"float:left;min-height:26px\"><span class=\"col twoabilitycol\">Regenerator</span></span><span style=\"float:left;min-height:26px\"><span class=\"col statcol\"><em>HP</em><br>125</span> <span class=\"col statcol\"><em>Atk</em><br>65</span> <span class=\"col statcol\"><em>Def</em><br>105</span> <span class=\"col statcol\"><em>SpA</em><br>170</span> <span class=\"col statcol\"><em>SpD</em><br>105</span> <span class=\"col statcol\"><em>Spe</em><br>30</span> <span class=\"col bstcol\"><em>BST<br>600</em></span> </span></li><li style=\"clear:both\"></li></ul></div><br />" +
