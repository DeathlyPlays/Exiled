...
Profile.prototype.background = function (buddy) {
	...
	return '<div style="background-image :url(' + bg + '); background-repeat: no-repeat;background-size: cover;">';
};
...
exports.commands = {
	...
	badgehelp: function (target, room, user) {
		let display = '';
		display += '<div class="infobox-limited"><center><b>Exiled Badge Plugin By Amber, Insist, and Execute.</b></center>';
