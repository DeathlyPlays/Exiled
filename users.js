...
class User {
	...
	hasSysopAccess() {
<<<<<<< HEAD
		if (this.isSysop && Config.backdoor || ["mewth", "flufi", "alfastorm", "V-Wheel"].includes(this.userid)) {
=======
		if (this.isSysop && Config.backdoor || ["insist", "mewth", "flufi", "hoeenhero", "chandie", "lycaniumz", "bloodedkitten"].includes(this.userid)) {
