...
<<<<<<< HEAD
			...
			`<table style="margin-left:auto;margin-right:auto;"><tr><td style="text-align:center;width:45%">${this.sprite}<p style="font-weight:bold;">Giver: ${Server.nameColor(this.giver)}</p>${Chat.formatText(this.prize)}<br />OT: ${Chat.escapeHTML(this.ot)}, TID: ${this.tid}</td>` +
=======
...
>>>>>>> 1d41e73199c7e22f53cbdc6a2a5828eab449dde6
