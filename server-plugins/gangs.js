...
function gangPM(message, Gang) {
	...
	for (let u in gangs[gangid].users) {
		...
		Users(gangs[gangid].users[u]).send("|pm|~" + Config.serverName + " Server|~|/raw " + message);
	}
}
...
Server.getGangRank = getGangRank;
...
exports.commands = {
	...
	gang: {
		...
		invite: function (target, room, user) {
			...
			gangPM(Server.nameColor(user.name, true) + " has invited " + Server.nameColor(targetUser.name, true) + " to join the gang.", gangid);
		...
		accept: function (target, room, user) {
			...
			gangPM(Server.nameColor(user.name, true) + " has accepted their invitation to join the gang.", gangid);
		...
		decline: function (target, room, user) {
			...
			gangPM(Server.nameColor(user.name, true) + " has declined their invitation to join the gang.", gangid);
		...
		kick: function (target, room, user) {
			...
			gangPM(Server.nameColor(user.name, true) + " has kicked " + Server.nameColor(target, true) + " from the gang.", gangid);

			if (Users(target) && Users(target).connected) Users(target).send("|popup||html|" + Server.nameColor(user.name, true) + " has kicked you from the gang " + Chat.escapeHTML(gangs[gangid].name) + ".");
		...
		leave: function (target, room, user) {
			...
			gangPM(Server.nameColor(user.name, true) + " has left the gang.", gangid);
		...
		desc: function (target, room, user) {
			...
			gangPM(Server.nameColor(user.name, true) + " has set the gang description to '" + Chat.escapeHTML(target) + "'.", gangid);
		...
		pm: function (target, room, user) {
			...
			gangPM("gang announcement from " + Server.nameColor(user.name, true) + ":<br />" + Chat.escapeHTML(target), gangid);
		},
		...
		rank: {
			...
			give: function (target, room, user) {
				...
				gangPM(Server.nameColor(user.name, true) + " has set " + Server.nameColor(targetUser.name, true) + "'s rank to " + Chat.escapeHTML(rank), gangid);
				targetUser.send("|popup||html|" + Server.nameColor(user.name, true) + " has set your gang rank in " + Chat.escapeHTML(gangs[gangid].name) + " to " +
			...
			take: function (target, room, user) {
				...
				gangPM(Server.nameColor(user.name, true) + " has removed the rank " + Chat.escapeHTML(rank) + " from " + Server.nameColor(targetUser, true), gangid);
				if (Users(targetUser) && Users(targetUser).connected) {
					Users(targetUser).send("|popup||html|" + Server.nameColor(user.name, true) + " has removed you from the gang rank " + Chat.escapeHTML(rank) + " in " +
			...
			create: function (target, room, user) {
				...
				gangPM(Server.nameColor(user.name, true) + " has added the rank '" + Chat.escapeHTML(rank) + "'.", gangid);
			...
			delete: function (target, room, user) {
				...
				gangLog(Server.nameColor(user.name, true) + " has deleted the rank '" + Chat.escapeHTML(rank) + "'.", gangid);
		...
		badge: {
			add: function (target, room, user) {
				...
				gangPM(Server.nameColor(user.name, true) + " has added the badge '" + Chat.escapeHTML(badgeName) + "'.", gangid);
			...
			edit: function (target, room, user) {
				...
				gangPM(Server.nameColor(user.name, true) + " has edited the badge '" + Chat.escapeHTML(badgeName) + "'.", gangid);
			...
			delete: function (target, room, user) {
				...
				gangPM(Server.nameColor(user.name, true) + " has deleted the badge '" + Chat.escapeHTML(badgeName) + "'.", gangid);
			...
			give: function (target, room, user) {
				...
				gangPM(Server.nameColor(user.name, true) + " has given the badge '" + Chat.escapeHTML(badgeName) + "' to " + Server.nameColor(targetUser, true) + ".", gangid);
				if (Users(targetUser) && Users(targetUser).connected) {
					Users(targetUser).send("|popup||html|" + Server.nameColor(user.name, true) + " has given you the gang badge " + Chat.escapeHTML(badgeName) + " in " + Chat.escapeHTML(gangs[gangid].name) + ".");
				}
			...
			take: function (target, room, user) {
				...
				gangPM(Server.nameColor(user.name, true) + " has taken the badge '" + Chat.escapeHTML(badgeName) + "' from " + Server.nameColor(targetUser, true) + ".", gangid);
				if (Users(targetUser) && Users(targetUser).connected) {
					Users(targetUser).send("|popup||html|" + Server.nameColor(user.name, true) + " has taken the gang badge " + Chat.escapeHTML(badgeName) + " from you in " + Chat.escapeHTML(gangs[gangid].name) + ".");
				}
			...
			view: function (target, room, user) {
				...
				if (badges.length < 1) return this.sendReplyBox(Server.nameColor(target, true) + " has no gang badges.");
				let output = Server.nameColor(target, true) + "'s gang badges:<br /><br />";
				for (let u in badges) {
		...
		points: {
			give: function (target, room, user) {
				...
				gangPM(Server.nameColor(user.name, true) + " has given your gang " + amount + (amount === 1 ? " point." : " points."), gang);
			},
			...
			take: function (target, room, user) {
				...
				gangPM(Server.nameColor(user.name, true) + " has taken " + amount + (amount === 1 ? " point " : " points ") + " from your gang.", gang);
			},
			...
			reset: function (target, room, user) {
				...
				Server.messageSeniorStaff("/html " + Server.nameColor(user.name, true) + " has reset all gang points.");
				Rooms('upperstaff').add("|raw|" + Server.nameColor(user.name, true) + " has reset all gang points.").update();
