...
exports.commands = {
	...
	customavatar: {
		set: function (target, room, user) {
			...
			if (Users(name)) Users(name).popup("|html|" + Dew.nameColor(user.name, true) + " set your custom avatar.<br /><center><img src='" + avatarUrl + "' width='80' height='80'></center><br /> Refresh your page if you don't see it.");
		},
		...
		delete: function (target, room, user) {
			...
			FS.unlink(AVATAR_PATH + image, err => {
				...
				if (Users(userid)) Users(userid).popup("|html|" + Dew.nameColor(user.name, true) + " has deleted your custom avatar.");
