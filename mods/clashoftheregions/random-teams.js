	...
	randomCOTRTeam() {
		...
		let sets = {
			...
			"Kiawe": {
				...
				item: "Focus Sash",
				gender: "M",
				moves: ['fakeout', 'flamethrower', 'hiddenpowergrass'],
			...
			"Mallow": {
				...
				item: "Leftovers",
				gender: "F",
				moves: ['leafblade', 'defog', 'swordsdance'],
			...
			"Gladion": {
				...
				item: "Steel Memory",
				gender: "M",
				moves: ['multiattack', 'airslash', 'triattack'],
			...
			"Lusamine": {
				...
				item: "Choice Scarf",
				gender: "F",
				moves: ['powergem', 'dazzlinggleam', 'psychic'],
				signatureMove: "Sludge Wave",
				evs: {
					spa: 252,
					spd: 4,
			...
			"Guzma": {
				...
				item: "Life Orb",
				gender: "M",
				moves: ['firstimpression', 'liquidation', 'leechlife'],
				signatureMove: "Aqua Jet",
				evs: {
					atk: 252,
					def: 4,
			...
			"Plumeria": {
				...
				item: "Black Sludge",
				gender: "F",
				moves: ['recover', 'scald', 'toxicspikes'],
			...
			"Olivia": {
				...
				item: "Life Orb",
				gender: "F",
				moves: ['stoneedge', 'thunderfang', 'accelrock'],
				signatureMove: "Sucker Punch",
				evs: {
					atk: 252,
					spe: 252,
			...
			"Kahili": {
				...
				item: "Leftovers",
				gender: "F",
				moves: ['furyattack', 'bravebird', 'rockblast'],
			...
			"Sophocles": {
				...
				item: "Air Balloon",
				gender: "M",
				moves: ['fakeout', 'fellstinger', 'spikyshield'],
			...
			"Hapu": {
				...
				item: "Leftovers",
				gender: "F",
				moves: ['earthquake', 'rockslide', 'sleeptalk'],
				signatureMove: "Rest",
				evs: {
					atk: 252,
					hp: 252,
			...
			"Nanu": {
				...
				item: "Life Orb",
				gender: "M",
				moves: ['fakeout', 'nightslash', 'playrough'],
			...
			"Hala": {
				...
				item: "Choice Band",
				gender: "M",
				moves: ['icepunch', 'closecombat', 'rockslide'],
				signatureMove: "Earthquake",
				evs: {
					atk: 252,
					def: 4,
			...
			"Acerola": {
				...
				item: "Normalium Z",
				gender: "F",
				moves: ['shadowclaw', 'playrough', 'shadowsneak'],
			...
			"Kukui": {
				...
				item: "Life Orb",
				gender: "M",
				moves: ['rockslide', 'accelrock', 'thunderfang'],
				signatureMove: "Sucker Punch",
				evs: {
					atk: 252,
					hp: 4,
			...
			"Mina": {
				...
				item: "Leftovers",
				gender: "F",
				moves: ['bugbuzz', 'psychic', 'quiverdance'],
			...
			"Molayne": {
				...
				item: "Life Orb",
				gender: "M",
				moves: ['iciclecrash', 'ironhead', 'earthquake'],
