...
exports.BattleScripts = {
	randomPmdTeam: function (side) {
		...
		for (let i = 0; i < 4; i++) {
			...
			let sigItems = ['Oran Berry', 'Apple', 'Blast Seed', 'Gravelrock', 'Heal Seed', 'Trap Orb', 'TrapBust Orb', 'Stun Seed', 'Totter Seed', 'Vile Seed', 'Violent Seed', 'Rainy Orb', 'Sunny Orb', 'Sandy Orb', 'Hail Orb', 'One Shot Orb', 'Warp Orb', 'Escape Orb', 'Stick', 'Iron Thorn', 'Evasion Orb', 'Mug Orb', 'Awakening', 'Wonder Orb', 'Quick Seed', 'Blinker Seed', 'Sleep Seed', 'X-Eye Seed', 'Slip Seed', 'Drought Orb', 'Decoy Orb', 'Pounce Orb', 'Sizebust Orb', 'Transfer Orb'];
			let choosenItems = [];
			let awakened = false;
			for (let h = 0; h < 4; h++) {
