...
exports.commands = {
	...
	serverannouncements: {
		...
		request: function (target, room, user) {
			...
			if (!target) return this.sendReply("/news request [message] - Requests a news announcement from Exiled Staff.");
			if (target.length < 1) return this.sendReply("/news request [message] - Requests a news announcement from Exiled Staff.");
