...
class UNOgame extends Rooms.RoomGame {
	...
	onUno(user, unoId) {
		...
		this.sendToRoom(Chat.html`|raw|<strong>UNO!</strong> $${Exiled.nameColor(user.name, true, true)} is down to their last card!`);
	...
	onWin(player) {
		...
		for (let i = 0; i < this.players.length; i++) {
			Exiled.addExp(Users(this.players[i]).userid, this.room, 20);
		}
